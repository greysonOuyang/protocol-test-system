...
//@Slf4j
//@Component
//public class InitialHandler extends SimpleChannelInboundHandler<RequestMainDTO> {
//
//    @Override
//    protected void channelRead0(ChannelHandlerContext ctx, RequestMainDTO requestMainDTO) throws Exception {
//        Channel currentChannel = ctx.channel();
//        //获取客户端传输过来的消息
//        Object body = requestMainDTO.getData().getRequestHeader().getBody();
//        String content = JSON.toJSONString(body);
//        log.info("[websocket]主机--{}接收到的消息：{}", ctx.channel().remoteAddress(), content);
//        Integer code = requestMainDTO.getCode();
//
//        // TODO 根据消息类型选择不同处理
