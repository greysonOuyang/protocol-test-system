 ...
 * @since 2021/4/27
 */
public class NettyServerInitializer extends AbstractNettyInitializer<SocketChannel> {
...
//        pipeline.addLast(new ModBusDecoder());
        pipeline.addLast(new ProjectConfigHandler(serviceInterface, ConstantValue.SERVER));
    }
}
